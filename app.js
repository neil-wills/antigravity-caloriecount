...
function initOnboarding() {
  ...
  onboardingForm.addEventListener('submit', (e) => {
    ...
    // Switch view to Dashboard on setup completion
    switchTab('dashboard');
  });
}
...
function renderMealsLog() {
  ...
  const mealSVGs = {
    breakfast: `<svg class="meal-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width: 22px; height: 22px; margin-right: 6px;"><circle cx="10" cy="12" r="7"/><circle cx="10" cy="12" r="2.8" fill="currentColor" fill-opacity="0.3" stroke-width="1.5"/><path d="M15.5 15.5L21 21" stroke-width="2.5"/><path d="M7 2.5C7 2.5 8 3.5 8 4.5" stroke-width="1.5"/><path d="M10 1.5C10 1.5 11 2.5 11 3.5" stroke-width="1.5"/><path d="M13 2.5C13 2.5 14 3.5 14 4.5" stroke-width="1.5"/></svg>`,
    lunch: `<svg class="meal-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width: 22px; height: 22px; margin-right: 6px;"><path d="M3 11C3 16 7 19.5 12 19.5C17 19.5 21 16 21 11H3Z" fill="currentColor" fill-opacity="0.15"/><path d="M6 11C6 8.5 8.5 7 10 7C11.5 7 12 8 12 8C12 8 12.5 7 14 7C15.5 7 18 8.5 18 11" stroke-width="1.8"/><path d="M12 2.5V7M9.5 2.5V5.5M14.5 2.5V5.5" stroke-width="1.6"/><path d="M8 14.5H16" stroke-width="1.5" opacity="0.4"/></svg>`,
    dinner: `<svg class="meal-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width: 22px; height: 22px; margin-right: 6px;"><circle cx="12" cy="12" r="8.5"/><circle cx="12" cy="12" r="4.8" stroke-width="1.5" stroke-dasharray="2 2" fill="currentColor" fill-opacity="0.12"/><path d="M2.5 6V18M1.5 6H3.5M1.5 9.5H3.5" stroke-width="1.8"/><path d="M21.5 6V18M21.5 6C19.8 6 19.8 9 19.8 11V18" stroke-width="1.8"/></svg>`,
    snacks: `<svg class="meal-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width: 22px; height: 22px; margin-right: 6px;"><path d="M12 20.5C7.5 20.5 4.5 17 4.5 12.8C4.5 9.5 6.8 7.5 9.2 7.5C10.6 7.5 11.5 8.3 12 8.3C12.5 8.3 13.4 7.5 14.8 7.5C17.2 7.5 19.5 9.5 19.5 12.8C19.5 17 16.5 20.5 12 20.5Z" fill="currentColor" fill-opacity="0.15"/><path d="M12 7.5V3.8" stroke-width="2"/><path d="M12 3.8C14 2 17 2.8 17 2.8C17 2.8 17 5.5 15 6.5" stroke-width="1.6" fill="currentColor" fill-opacity="0.3"/></svg>`
  };
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (hasProfile) {
    ...
    updateDisplayTitle();
    applyTrackerVisibility();
    switchTab('dashboard'); // Dashboard is the default landing view
  } else {
